...
/usr/bin/raspistill  --quality 100 --ISO 100 --exposure night --metering spot --sharpness 20 --ev 0 --drc low --contrast 20 --saturation 20 --annotate 12 -o /media/pi/SAMSUNG_T5/streaming16/still$(date +"%Y%m%dT%H%M").jpg
